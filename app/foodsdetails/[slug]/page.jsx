...
const page = () => {
   const params = useParams()
   //  console.log(params)
   const breads = foodJson.find((bread) => bread.id == params.slug)     
...
<Image src={breads.img} width={225} height={225} alt={breads.name} className='h-[225px] w-[225px] md:w-[320px] md:h-[320px] rounded-full'/> 
</div>
<div className='font-semibold flex justify-center items-center flex-col space-y-3 mt-6 md:mt-10'>
<p className=' text-[21px] capitalize  md:text-[28px] text-center'>{breads.name}</p>
<p className='text-[#FFC83A] text-[17px] md:text-[22px]'>Rs {breads.price}</p>
</div>
...
<Link href='/cart'>
<div className='mt-10 pb-3 flex justify-center md:min-h-[25vh] md:items-end'>
